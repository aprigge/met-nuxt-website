...
/******/ 			var chunk = require("./" + ({"1":"components/title-block","2":"pages/index"}[chunkId]||chunkId) + ".js");
...
__webpack_require__.d(components_namespaceObject, "TitleBlock", function() { return TitleBlock; });
...
const _1c0dcf67 = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 2).then(__webpack_require__.bind(null, 24)));
...
const TitleBlock = __webpack_require__.e(/* import() | components/title-block */ 1).then(__webpack_require__.bind(null, 25)).then(c => wrapFunctional(c.default || c));
...
/* harmony default export */ var nuxt_axios = ((ctx, inject) => {
  ...
  const baseURL =  false ? undefined : runtimeConfig.baseURL || runtimeConfig.baseUrl || process.env._AXIOS_BASE_URL_ || 'https://api.spotify.com/v1/'; // Create fresh objects for all default header scopes
